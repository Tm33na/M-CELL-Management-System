...
public class AdminForgotPasswordServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            statement = con.prepareStatement("SELECT * FROM admin WHERE email = ?");
            statement.setString(1, email);
            rs = statement.executeQuery();
            
            if (rs.next()) {
                String username = rs.getString("admin_id");
                ...
                RequestDispatcher rd = request.getRequestDispatcher("AdminForgotPassword.html");
                rd.include(request, response);
            }
