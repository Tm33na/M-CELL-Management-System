...
public class GetUnreadAdminNotificationCountServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String query = "SELECT COUNT(*) AS unread_count FROM Adminnotifications WHERE status = 'Unread'";
